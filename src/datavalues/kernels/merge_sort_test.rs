...
fn test_indices_other() -> crate::error::FuseQueryResult<()> {
    use crate::datavalues::merge_indices;
...
#[test]
fn test_merge_array() -> crate::error::FuseQueryResult<()> {
    use crate::datavalues::merge_array;
    use crate::datavalues::merge_indices;
...
#[test]
fn test_merge_array2() -> crate::error::FuseQueryResult<()> {
    use crate::datavalues::merge_array;
    use crate::datavalues::merge_indices;
    use crate::datavalues::DataArrayRef;
    use crate::datavalues::UInt32Array;
